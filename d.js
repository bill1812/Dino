...
(function () {
  ...
  /** Default game width. @const */
  var DEFAULT_WIDTH = 600;

  /** Frames per second. @const */
  var FPS = 60;
  ...
  /** Default game configuration. @enum {number} */
  Runner.config = {
    ACCELERATION: 0.001,
    BG_CLOUD_SPEED: 0.2,
    BOTTOM_PAD: 10,
  ...
  /** Default dimensions. @enum {string} */
  Runner.defaultDimensions = {
    WIDTH: DEFAULT_WIDTH,
    HEIGHT: 150
  };

  /** CSS class names. @enum {string} */
  Runner.classes = {
  ...
  /** Sprite definition layout of the spritesheet. @enum {Object} */
  ...
  /** Sound FX. Reference to the ID of the audio tag on interstitial page. @enum {string} */
  Runner.sounds = {
  ...
  /** Runner event names. @enum {string} */
  Runner.events = {
  ...
  Runner.prototype = {
    ...
    /** Whether the easter egg has been disabled. CrOS enterprise enrolled devices. @return {boolean} */
    isDisabled: function () {
    ...
    // Cache the appropriate image sprite from the page and get the sprite sheet definition.
    loadImages: function () {
      if (IS_HIDPI) {
    ...
    onKeyDown: function (e) {
      ...
      if (this.isCanvasInView()) {
        ...
        } else if (IS_IOS && this.crashed && e.type == Runner.events.TOUCHSTART && e.currentTarget == this.containerEl) {
    ...
    /** Whether the game should go into arcade mode. @return {boolean} */
    ...
    setArcadeModeContainerScale: function () {
      ...
      var translateY = Math.ceil(Math.max(0, (windowHeight - scaledCanvasHeight -
        ...
        Runner.config.ARCADE_MODE_TOP_POSITION_PERCENT)) * window.devicePixelRatio;
    ...
    /** Play a sound. @param {SoundBuffer} soundBuffer */
  ...
  /** Return the current timestamp. @return {number} */
  ...
  /** Dimensions used in the panel. @enum {number} */
  ...
  function checkForCollision(obstacle, tRex, opt_canvasCtx) {
    ...
    // border around the t-rex and obstacles (障礙).
  ...
  /** Coefficient for calculating the maximum gap. @const */
  Obstacle.MAX_GAP_COEFFICIENT = 1.5;

  /** Maximum obstacle grouping count. @const */
  Obstacle.MAX_OBSTACLE_LENGTH = 3,
    Obstacle.prototype = {

      /** Initialise the DOM for the obstacle. @param {number} speed */
      init: function (speed) {
  ...
  /** T-rex player config. @enum {number} */
  Trex.config = {
    DROP_VELOCITY: -5,
    GRAVITY: 0.6,
    HEIGHT: 47,
  ...
  /** Used in collision detection. @type {Array<CollisionBox>} */
  Trex.collisionBoxes = {
    DUCKING: [
  ...
  /** Blinking coefficient. @const */
  Trex.BLINK_TIMING = 7000;

  /** Animation config for different states. @enum {Object} */
  Trex.animFrames = {
  ...
  /** Distance meter config. @enum {number} */
  ...
  DistanceMeter.prototype = {
    ...
    /** Whether high score is flashing. @return {boolean} */
    isHighScoreFlashing() {
  ...
  /** Cloud object config. @enum {number} */
  Cloud.config = {
    HEIGHT: 14,
    MAX_CLOUD_GAP: 400,
    MAX_SKY_LEVEL: 30,
  ...
  /** Horizon line dimensions. @enum {number} */
  ...
  Horizon.prototype = {
    ...
    updateObstacles: function (deltaTime, currentSpeed) {
      ...
      if (this.obstacles.length > 0) {
        ...
        if (lastObstacle && !lastObstacle.followingObstacleCreated && lastObstacle.isVisible() &&
